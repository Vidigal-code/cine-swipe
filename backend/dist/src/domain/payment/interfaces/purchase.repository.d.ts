...
import { CreateOutboxEventInput, PaymentOutbox, PaymentOutboxStatus } from '../entities/payment-outbox.entity';
export declare const PURCHASE_REPOSITORY = "PURCHASE_REPOSITORY";
