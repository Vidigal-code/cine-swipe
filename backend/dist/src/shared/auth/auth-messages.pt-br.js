...
exports.AUTH_MESSAGES_PT_BR = void 0;
const AUTH_PROVIDER_FIREBASE = 'AUTH_PROVIDER=firebase';
exports.AUTH_MESSAGES_PT_BR = {
    ...
    strongPasswordPolicy: 'A senha deve ter 8 a 64 caracteres com letra maiuscula, letra minuscula, numero e simbolo.',
    ...
    passwordUpdateNotAvailable: 'Atualizacao de senha indisponivel para este tipo de conta.',
    firebaseIdTokenRequired(provider = AUTH_PROVIDER_FIREBASE) {
        return `firebaseIdToken obrigatorio quando ${provider}.`;
    },
};
//# sourceMappingURL=auth-messages.pt-br.js.map