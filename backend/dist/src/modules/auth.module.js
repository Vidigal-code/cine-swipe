...
const user_repository_2 = require("../domain/user/interfaces/user.repository");
const database_module_1 = require("../infrastructure/database/database.module");
const firebase_auth_service_1 = require("../infrastructure/auth/firebase-auth.service");
const auth_provider_service_1 = require("../application/auth/auth-provider.service");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            {
                provide: user_repository_2.USER_REPOSITORY,
